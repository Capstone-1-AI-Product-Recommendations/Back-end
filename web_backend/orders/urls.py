...
from .views import create_order, update_shipping_address, cancel_order_item, get_user_addresses, add_shipping_address, create_order_restapi

urlpatterns = [
    path('order/create_order/<int:user_id>/', create_order, name='create_order'),
    path('orders/create/', create_order_restapi, name='create_order_restapi'),
